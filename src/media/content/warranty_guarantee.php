...
<main class="container">
	<article class="card">
		<header style="text-align: center;">
			<?php echo xtc_image(DIR_WS_IMAGES . 'warranty_guarantee/legal_guarantee_' . $_SESSION["language_code"] . '.jpg', TEXT_WARRANTY_AND_GUARANTEE_TITLE, '', '', 'style="max-width: 50%; margin: 0 auto;"'); ?>
		</header>
		<section>
