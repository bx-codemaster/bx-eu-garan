 ...
 */
  ...
  define('MODULE_BX_EU_GARAN_ENABLE_AUDIO_TITLE', 'Audio aktivieren?');
  define('MODULE_BX_EU_GARAN_ENABLE_AUDIO_DESC', 'Soll Audioausgabe für Fehlermeldungen aktiviert werden?');
  ...
  define('MODULE_BX_EU_GARAN_CATEGORIES_INSTALL_NEXT', 'Bitte installieren Sie jetzt das Modul "BX EU Garan Kategorien". (Module -> Klassenerweiterungen -> Kategorien)');
  define('MODULE_BX_EU_GARAN_ORDER_INSTALL_NEXT', 'Bitte installieren Sie jetzt das Modul "BX EU Garan Bestellungen". (Module -> Klassenerweiterungen -> Bestellungen)');
  define('MODULE_BX_EU_GARAN_CART_INSTALL_NEXT', 'Bitte installieren Sie jetzt das Modul "BX EU Garan Warenkorb". (Module -> Klassenerweiterungen -> Warenkorb)');

  define('MODULE_BX_EU_GARAN_EXTENSIONS_MISSING', 'Fehlende Erweiterungen: %s. Diese sind Voraussetzung für eine erfolgreiche Installation des Moduls.');
