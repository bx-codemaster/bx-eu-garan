 ...
 */
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $formData = array(
      ...
      'set_guarantee_years'           => 0,
      'guarantee_years'               => 2,
      'set_covers_full_product'       => 0,
      'covers_full_product'           => 0,
      'set_requires_additional_cost'  => 0,
              ...
              <?php echo xtc_draw_form('bx_eu_garan_form', 'bx_eu_garan.php'); ?>
                ...
                <div class="clear div_box" style="max-width: 100%; border-radius: 4px;">
                  ...
                  <table class="tableConfig">
                    <tr class="dataTableHeadingRow" style="border-left: 1px solid #aaaaaa;"><td class="dataTableHeadingContent" colspan="3"><?php echo TEXT_BX_EU_GARAN_TABLE_HEADING_FILTER; ?></td></tr>
                    <tr>
                    ...
                    <tr><td class="col-left"><?php echo TEXT_BX_EU_GARAN_FIELD_PRODUCT_STATUS; ?></td><td class="col-middle"><?php echo xtc_draw_pull_down_menu('filter_status', $statusSelectData, (string)$formData['filter_status']); ?></td></tr>
                  </table>
                </div>

                <details class="bxac-card" style="margin-bottom: 1em;" open>
                  <summary class="bxac-summary"><span class="bxac-arrow" style="font-size: 25px; line-height: 16px;">▸</span><span class="bxac-title"><?php echo HEADING_BX_EU_GARAN_PRODUCT_WARRANTY; ?></span></summary>
                  <div class="bxac-body" style="padding: 0;">
                    <table class="tableBXConfig" style="margin-top: 0;">
                      <tr class="dataTableHeadingRow" style="border-left: 1px solid #aaaaaa;"><td class="dataTableHeadingContent"><?php echo TEXT_BX_EU_GARAN_TABLE_HEADING_FIELD; ?></td><td class="dataTableHeadingContent txta-c"><?php echo TEXT_BX_EU_GARAN_TABLE_HEADING_SET; ?></td><td class="dataTableHeadingContent"><?php echo TEXT_BX_EU_GARAN_TABLE_HEADING_VALUE; ?></td><td class="dataTableHeadingContent"><?php echo TEXT_BX_EU_GARAN_TABLE_HEADING_NOTE; ?></td></tr>
                      <tr><td class="col-left"><?php echo TEXT_BX_EU_GARAN_FIELD_GUARANTEE_ACTIVE; ?></td><td class="col-middle txta-c"><?php echo xtc_draw_checkbox_field('set_manufacturer_guarantee_available', '1', $formData['set_manufacturer_guarantee_available'] === 1); ?></td><td class="col-right"><?php echo xtc_cfg_select_option(array('true', 'false'), ($formData['manufacturer_guarantee_available'] === 1 ? 'true' : 'false'), 'manufacturer_guarantee_available'); ?></td><td class="col-right"><?php echo TEXT_BX_EU_GARAN_FIELD_GUARANTEE_ACTIVE_NOTE; ?></td></tr>
                      <tr><td class="col-left"><?php echo TEXT_BX_EU_GARAN_FIELD_GUARANTEE_YEARS; ?></td><td class="col-middle txta-c"><?php echo xtc_draw_checkbox_field('set_guarantee_years', '1', $formData['set_guarantee_years'] === 1); ?></td><td class="col-right" style="width: 30%;"><input type="number" min="0" step="1" name="guarantee_years" value="<?php echo (int)$formData['guarantee_years']; ?>"></td><td class="col-right"><?php echo TEXT_BX_EU_GARAN_FIELD_GUARANTEE_YEARS_NOTE; ?></td></tr>
                      <tr><td class="col-left"><?php echo TEXT_BX_EU_GARAN_FIELD_COVERS_FULL_PRODUCT; ?></td><td class="col-middle txta-c"><?php echo xtc_draw_checkbox_field('set_covers_full_product', '1', $formData['set_covers_full_product'] === 1); ?></td><td class="col-right"><?php echo xtc_cfg_select_option(array('true', 'false'), ($formData['covers_full_product'] === 1 ? 'true' : 'false'), 'covers_full_product'); ?></td><td class="col-right"><?php echo TEXT_BX_EU_GARAN_FIELD_COVERS_FULL_PRODUCT_NOTE; ?></td></tr>
                      <tr><td class="col-left"><?php echo TEXT_BX_EU_GARAN_FIELD_REQUIRES_ADDITIONAL_COST; ?></td><td class="col-middle txta-c"><?php echo xtc_draw_checkbox_field('set_requires_additional_cost', '1', $formData['set_requires_additional_cost'] === 1); ?></td><td class="col-right"><?php echo xtc_cfg_select_option(array('true', 'false'), ($formData['requires_additional_cost'] === 1 ? 'true' : 'false'), 'requires_additional_cost'); ?></td><td class="col-right"><?php echo TEXT_BX_EU_GARAN_FIELD_REQUIRES_ADDITIONAL_COST_NOTE; ?></td></tr>
                    </table>
                  </div>
                </details>
...
<?php
  ...
  if (!empty($heading) && !empty($contents)) { $box = new box; echo $box->infoBox($heading, $contents); }

  $heading = array(); $contents = array();
  ...
  if (!empty($messageStack->errors['error']) && defined('MODULE_BX_EU_GARAN_ENABLE_AUDIO') && MODULE_BX_EU_GARAN_ENABLE_AUDIO === 'True') {
    echo '<script>(function(){var audio=document.getElementById("bx-eu-garan-error-sound"),warning=document.getElementById("bx-eu-garan-autoplay-warning"),error_heading=document.getElementById("bx-eu-garan-error_heading");if(!audio||!warning||!error_heading){return;}var playPromise=audio.play();if(playPromise!==undefined){playPromise.catch(function(){warning.style.display="inline-block";error_heading.style.display="inline-block";});}}());</script>';
  }
?>
            </td>
          </tr>
